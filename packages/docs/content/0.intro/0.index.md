...
::list{type="info"}
**By default Mustard provides ESM-based modern development workflow, and `tsx` can run TypeScript entry files directly without extra experimental Node flags.**
::
